...
```{r}
liz_access <- read.GenBank("FJ356743", as.character = TRUE)
```

```{r}
write.fasta(names= "Liz-1", sequences= liz_access, file.out="data/Liz-1.fasta" )
```


```{r}
liz <- read.fasta(file = "data/Liz-1.fasta")
```
