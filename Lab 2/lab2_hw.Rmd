...
```{r}
#You don't need to make these objects, we can do the calculations in the objusts "large" and "small"
S <- small$bodywt
L <- large$bodywt
```
...
mean(Large_sleep)
#again, we can do this in the object we already made
...
```{r}
#Oh no, it's blank! Here's a suggestion for how you could have done it-
