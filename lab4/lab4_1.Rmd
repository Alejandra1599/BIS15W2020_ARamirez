...
#####the income is part of the data but instead are column names

3. Use `pivot_longer()` to make the data tidy.  

```{r}
relig_income %>%
  pivot_longer(-religion, names_to = "income", values_to = "members")
```
...
```{r}
plant_data %>%
  pivot_longer(day1:day30, names_to = "day", names_prefix = "day", values_to = "measure")
```
